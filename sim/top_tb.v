...
module top_tb();
    ...
    // Register snapshot storage for Phase 1
    reg [31:0] reg_snap [1:31];
    ...
    initial begin
        ...
        wait(uut.pc == 32'd292);
        @(negedge clk);
        // Take snapshot of registers before M-extension modifies them
        for (idx = 1; idx <= 31; idx = idx + 1) begin
            reg_snap[idx] = uut.reg_file.registers[idx];
        end

        // Wait until all M-extension instructions complete (including 32-cycle dividers)
        #3000;
        ...
        // Test 1: ADD
        if (reg_snap[6] == 32'h00000008) begin
        ...
        $display("Expected: 0x00000008, Got: 0x%h", reg_snap[6]);
        $display("--------------------");

        // Test 2: SUB
        if (reg_snap[7] == 32'h00000002) begin
        ...
        $display("Expected: 0x00000002, Got: 0x%h", reg_snap[7]);
        $display("--------------------");

        // Test 3: SLL
        if (reg_snap[8] == 32'h00000028) begin
        ...
        $display("Expected: 0x00000028, Got: 0x%h", reg_snap[8]);
        $display("--------------------");

        // Test 4: SLT
        if (reg_snap[9] == 32'h00000001) begin
        ...
        $display("Expected: 0x00000001, Got: 0x%h", reg_snap[9]);
        $display("--------------------");

        // Test 5: SLTU
        if (reg_snap[10] == 32'h00000000) begin
        ...
        $display("Expected: 0x00000000, Got: 0x%h", reg_snap[10]);
        $display("--------------------");

        // Test 6: XOR
        if (reg_snap[11] == 32'h00000006) begin
        ...
        $display("Expected: 0x00000006, Got: 0x%h", reg_snap[11]);
        $display("--------------------");

        // Test 7: SRL
        if (reg_snap[12] == 32'h00000000) begin
        ...
        $display("Expected: 0x00000000, Got: 0x%h", reg_snap[12]);
        $display("--------------------");

        // Test 8: SRA
        if (reg_snap[13] == 32'hFFFFFFFF) begin
        ...
        $display("Expected: 0xFFFFFFFF, Got: 0x%h", reg_snap[13]);
        $display("--------------------");

        // Test 9: OR
        if (reg_snap[14] == 32'h00000007) begin
        ...
        $display("Expected: 0x00000007, Got: 0x%h", reg_snap[14]);
        $display("--------------------");

        // Test 10: AND
        if (reg_snap[15] == 32'h00000001) begin
        ...
        $display("Expected: 0x00000001, Got: 0x%h", reg_snap[15]);
        $display("--------------------");

        // Test 11: ADDI
        if (reg_snap[16] == 32'h0000000F) begin
        ...
        $display("Expected: 0x0000000F, Got: 0x%h", reg_snap[16]);
        $display("--------------------");

        // Test 12: SLLI
        if (reg_snap[17] == 32'h00000014) begin
        ...
        $display("Expected: 0x00000014, Got: 0x%h", reg_snap[17]);
        $display("--------------------");

        // Test 13: SLTI
        if (reg_snap[18] == 32'h00000001) begin
        ...
        $display("Expected: 0x00000001, Got: 0x%h", reg_snap[18]);
        $display("--------------------");

        // Test 14: XORI
        if (reg_snap[19] == 32'h0000000A) begin
        ...
        $display("Expected: 0x0000000A, Got: 0x%h", reg_snap[19]);
        $display("--------------------");

        // Test 15: SRLI
        if (reg_snap[20] == 32'h00000002) begin
        ...
        $display("Expected: 0x00000002, Got: 0x%h", reg_snap[20]);
        $display("--------------------");

        // Test 16: SRAI
        if (reg_snap[21] == 32'hFFFFFFFF) begin
        ...
        $display("Expected: 0xFFFFFFFF, Got: 0x%h", reg_snap[21]);
        $display("--------------------");

        // Test 17: ORI
        if (reg_snap[22] == 32'h0000000D) begin
        ...
        $display("Expected: 0x0000000D, Got: 0x%h", reg_snap[22]);
        $display("--------------------");

        // Test 18: ANDI
        if (reg_snap[23] == 32'h00000004) begin
        ...
        $display("Expected: 0x00000004, Got: 0x%h", reg_snap[23]);
        $display("--------------------");

        // Test 19: LB
        if (reg_snap[24] == 32'hFFFFFFEF) begin
        ...
        $display("Expected: 0xFFFFFFEF, Got: 0x%h", reg_snap[24]);
        $display("--------------------");

        // Test 20: LH
        if (reg_snap[25] == 32'hFFFFCDEF) begin
        ...
        $display("Expected: 0xFFFFCDEF, Got: 0x%h", reg_snap[25]);
        $display("--------------------");

        // Test 21: LW
        if (reg_snap[26] == 32'h89ABCDEF) begin
        ...
        $display("Expected: 0x89ABCDEF, Got: 0x%h", reg_snap[26]);
        $display("--------------------");

        // Test 22: LBU
        if (reg_snap[27] == 32'h000000EF) begin
        ...
        $display("Expected: 0x000000EF, Got: 0x%h", reg_snap[27]);
        $display("--------------------");

        // Test 23: LHU
        if (reg_snap[28] == 32'h0000CDEF) begin
        ...
        $display("Expected: 0x0000CDEF, Got: 0x%h", reg_snap[28]);
        $display("--------------------");
        ...
        // Test 27: BEQ Not Taken
        if (reg_snap[30] == 32'h0000000A) begin
        ...
        $display("Expected: 0x0000000A, Got: 0x%h", reg_snap[30]);
        $display("--------------------");

        // Test 28: BEQ Taken
        if (reg_snap[31] == 32'h0000001E) begin
        ...
        $display("Expected: 0x0000001E, Got: 0x%h", reg_snap[31]);
        $display("--------------------");

        // Test 29: BNE Taken
        if (reg_snap[1] == 32'h00000032) begin
        ...
        $display("Expected: 0x00000032, Got: 0x%h", reg_snap[1]);
        $display("--------------------");

        // Test 30: BLT Taken
        if (reg_snap[2] == 32'h0000003C) begin
        ...
        $display("Expected: 0x0000003C, Got: 0x%h", reg_snap[2]);
        $display("--------------------");

        // Test 31: BGE Taken
        if (reg_snap[3] == 32'h00000050) begin
        ...
        $display("Expected: 0x00000050, Got: 0x%h", reg_snap[3]);
        $display("--------------------");

        // Test 32: BLTU Not Taken
        if (reg_snap[4] == 32'h00000064) begin
        ...
        $display("Expected: 0x00000064, Got: 0x%h", reg_snap[4]);
        $display("--------------------");

        // Test 33: BGEU Taken
        if (reg_snap[5] == 32'h00000078) begin
        ...
        $display("Expected: 0x00000078, Got: 0x%h", reg_snap[5]);
        $display("--------------------");
